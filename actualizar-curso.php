            ...
            <div class="main-page">
                ...
                <div class="container-fluid">
                    <div class="row page-title-div">
                        <div class="col-md-6">
                            <h2 class="title">Actualizar Datos del Curso</h2>
                    ...
                    <div class="row breadcrumb-div">
                        <div class="col-md-6">
                            <ul class="breadcrumb">
                                ...
                                <li> Cursos</li>
                                <li class="active">Actualizar Curso</li>
                            </ul>
                        </div>
                                    ...
                                    <form class="form-horizontal" method="post">
                                        ...
                                        if ($query->rowCount() > 0) {
                                            foreach ($results as $result) {   ?>
                                                ...
                                                <div class="form-group">
                                                    <label for="default" class="col-sm-2 control-label">Código del Curso</label>
                                                    <div class="col-sm-10">
                                        ...
                                        <div class="form-group">
                                            <div class="col-sm-offset-2 col-sm-10">
                                                <button type="submit" name="Update" class="btn btn-primary">Actualizar Curso</button>
                                            </div>
                                        </div>
                                    </form>
