            ...
            <div class="main-page">
                <div class="container-fluid">
                    <div class="row page-title-div">
                        <div class="col-md-6">
                            <h2 class="title">Actualizar Calificaciones del Estudiante</h2>
                    ...
                    <div class="row breadcrumb-div">
                        <div class="col-md-6">
                            <ul class="breadcrumb">
                                ...
                                <li class="active">Actualizar Calificaciones</li>
                            </ul>
                        </div>
                            ...
                            <div class="panel">
                                <div class="panel-heading">
                                    <div class="panel-title">
                                        <h5>Actualiza las Calificaciones del Estudiante</h5>
                                    </div>
                                </div>
                                <div class="panel-body">
                                    ...
                                    $ret = "SELECT tblstudents.StudentName,periodo_estudio.ClassName,periodo_estudio.Section from tblresult join tblstudents on tblresult.StudentId=tblresult.StudentId join tblsubjects on tblsubjects.id=tblresult.SubjectId join periodo_estudio on periodo_estudio.id=tblstudents.ClassId where tblstudents.StudentId=:stid limit 1";
                                    ...
                                    if ($stmt->rowCount() > 0) {
                                        foreach ($result as $row) {  ?>
                                            ...
                                            <div class="form-group">
                                                <label for="default" class="col-sm-4 control-label">Año</label>
                                                <div class="col-sm-8">
                                                    <?php echo htmlentities($row->ClassName) ?>(<?php echo htmlentities($row->Section) ?>)
                                                </div>
                                            </div>
                                            <div class="form-group">
                                                <label for="default" class="col-sm-4 control-label">Nombre Completo</label>
                                                <div class="col-sm-8">
                                    ...
                                    if ($query->rowCount() > 0) {
                                        foreach ($results as $result) {  ?>
                                            ...
                                            <div class="form-group">
                                                <label for="default" class="col-sm-4 control-label"><?php echo htmlentities($result->SubjectName) ?></label>
                                                <div class="col-sm-8">
                                    ...
                                    <div class="form-group">
                                        <div class="col-sm-offset-2 col-sm-10">
                                            <button type="submit" name="submit" class="btn btn-primary">Actualizar Calificaciones</button>
                                        </div>
                                    </div>
                                    </form>
