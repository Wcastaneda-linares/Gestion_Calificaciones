...
<body>
            ...
            <div class="content-container">
                ...
                <div class="main-page">
                    <div class="container-fluid">
                        ...
                        <h2><a href="https://www.NoteMaster.com/46-aplicaciones-gratuitas-en-php-python-y-javascript/#Aplicaciones-gratuitas-en-PHP,-Python-y-Javascript" target="_blank">NoteMaster</a></h2>
                            ...
                            <div class="row">
                                ...
                                <div class="col-md-8 col-md-offset-2">
                                    <div class="panel">
                                        <div class="panel-heading">
                                            <div class="panel-title">
                                                ...
                                                if ($stmt->rowCount() > 0) {
                                                    foreach ($resultss as $row) {   ?>
                                                        ...
                                                        <p><b>Carnet:</b> <?php echo htmlentities($row->RollId); ?>
                                                        <p><b>Semestre y Sección:</b> <?php echo htmlentities($row->ClassName); ?>(<?php echo htmlentities($row->Section); ?>)
                                                        <?php }
                                            ...
                                            <div class="panel-body p-20">
                                                ...
                                                <table class="table table-hover table-bordered" border="1" width="70%" style="margin: auto; text-align: center;">
                                                    <thead>
                                                    ...
                                                    <tbody>
                                                        ...
                                                        <?php
                                                            ...
                                                            <div class="alert alert-danger left-icon-alert" role="alert">
                                                                <strong>Hubieron Inconvenientes!</strong>
                                                            <?php
                                                            
                                                            echo htmlentities("No de Carnet no válido");
                                                        }
                                                            ?>
                                                            </div>
                                                    </tbody>
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="col-sm-6">
                                            <a href="index.php" style="color:white; text-align: center">Volver</a>
                                        </div>
                                    </div>
                                    
                                    <button class="btn btn-primary" onclick="downloadGrades()">Descargar Calificaciones</button>
                                </div>
                                <!-- /.row -->
    ...
    function downloadGrades() {
        // Aquí puedes agregar el código para la descarga de calificaciones, por ejemplo, redirigiendo a un archivo de descarga o generando un archivo en el servidor.
        alert('Descargando calificaciones...');
