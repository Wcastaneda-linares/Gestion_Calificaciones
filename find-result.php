                ...
                <div class="col-md-4 col-md-offset-7">
                    <div class="panel login-box" style="    background: #3d86ed;">
                        ...
                        <div class="panel-body p-20">
                            ...
                            <form action="result.php" method="post" class="docente-login">
                                <div class="form-group">
                                    <label for="rollid" class="control-label">Ingresa tu No. de Carnet</label>
                                    <input type="text" class="form-control" id="rollid" placeholder="Ingresa tu No. de Carnet" autocomplete="off" name="rollid">
                                </div>
                                <div class="form-group">
