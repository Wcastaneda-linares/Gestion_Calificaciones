                                ...
                                <div class="panel">
                                    ...
                                    <div class="panel-body">
                                        ...
                                        <form class="row" method="post">
                                            ...
                                            <div class="form-group col-md-6">
                                                <label for="default" class="control-label">Carnet</label>
                                                <input type="text" name="rollid" class="form-control" id="rollid" maxlength="8" required="required" autocomplete="off">

                                            </div>

                                            <div class="form-group col-md-6">
                                                <label for="default" class="control-label">Correo electrónico</label>
                                            ...
                                            <div class="form-group col-md-6">
                                                <label for="default" class="control-label">Sexo</label>
                                                <input type="radio" name="gender" value="Male" required="required" checked=""> Masculino     <input type="radio" name="gender" value="Female" required="required"> Femenino

                                            </div>


                                            <div class="form-group col-md-6">
                                                <label for="default" class="control-label">Semestre y Sección</label>
                                                <select name="class" class="form-control" id="default" required="required">
                                                    <option value="">Seleccionar Semestre y Sección</option>
                                            ...
                                            <div class="form-group col-md-12">
                                                <button type="submit" name="submit" class="btn btn-success">Agregar Estudiante</button>
                                            </div>
                                        </form>
