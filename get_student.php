    ...
    <?php
                                              ...
                                              if (!empty($_POST["classid1"])) {
                                                ...
                                                if (!is_numeric($cid1)) {
                                                  ...
                                                  while ($row = $stmt->fetch(PDO::FETCH_ASSOC)) { ?>
      <p style="color: #7c7c7c;"> <?php echo htmlentities($row['SubjectName']); ?><input type="text" name="marks[]" value="" class="form-control" required="" placeholder="Ingresar Calificación sobre 100" autocomplete="off"></p>
