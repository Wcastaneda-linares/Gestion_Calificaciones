            ...
            <div class="main-page">
                <div class="container-fluid">
                    <div class="row page-title-div">
                        <div class="col-md-6">
                            <h2 class="title">Gestionar Secciones</h2>
                    ...
                    <div class="row breadcrumb-div">
                        <div class="col-md-6">
                            <ul class="breadcrumb">
                                ...
                                <li> Secciones</li>
                                <li class="active">Gestionar Secciones</li>
                            </ul>
                        </div>
                                ...
                                <div class="panel">
                                    <div class="panel-heading">
                                        <div class="panel-title">
                                            <h5>Ver Información de Secciones Creadas</h5>
                                        </div>
                                    </div>
                                    <?php if ($msg) { ?>
                                                ...
                                                if ($query->rowCount() > 0) {
                                                    foreach ($results as $result) {   ?>
                                                        <tr>
                                                            ...
                                                            <td>
                                                                <a href="actualizar-semestre.php?classid=<?php echo htmlentities($result->id); ?>" class="btn btn-info"><i class="fa fa-edit" title="Edit Record"></i> </a>
